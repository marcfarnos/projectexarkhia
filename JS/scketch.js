...
animacio1.fromTo(".destacatitol", 4, {
    top: "0%",
    opacity: 0,
...
animaciocoronel.fromTo("#coronels", 4, {
...
animaciotetol.fromTo("#historia", 9, {
    opacity: 0,
    bottom:"40%",
}, {
    opacity: 1,
...
animaciotetol.fromTo("#historia", 10, {
    opacity: 1,
    scale:1,
}, {
    opacity: 1,
...
textdestacat3.fromTo("#destacatet3", 5, {
...
textdestacatmorfin.fromTo("#divdos4", 5, {
...
textdestacat4.fromTo("#destacatet4", 5, {
    bottom: "50%",
    opacity: 0,
}, {
    opacity: 1,
...
textdestacat7.fromTo("#destacatet7", 5, {
    opacity: 0,
    bottom: "50%",
}, {
    opacity: 1,
...
destacato.fromTo("#destacatet19", 5, {
    opacity: 0,
...
animacioactuali.fromTo("#titolactualitat", 9, {
    opacity: 0,
    bottom:"40%",
}, {
    opacity: 1,
...
animacioactuali.fromTo("#titolactualitat", 10, {
    opacity: 1,
    scale:1,
}, {
    opacity: 1,
...
textfinal.fromTo("#destacatetfinal", 5, {
    bottom: "50%",
    opacity: 0,
}, {
    opacity: 1,
...
contraporadanim.fromTo("#parrafcontra", 5, {
    bottom: "50%",
    opacity: 0,
}, {
    opacity: 1,
